...
function ToastCard({
  ...
  return (
    <div
      className={`flex items-center gap-3 bg-white rounded-xl shadow-card-lg ring-1 ${RING[toast.type]} px-4 py-3 pointer-events-auto min-w-[260px] max-w-[380px] animate-fade-up`}
    >
      <div
